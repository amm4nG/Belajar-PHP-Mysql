...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="container">
                    <h5 class="alert alert-info mt-3"><i class="bi bi-people-fill"></i> Data Mahasiswa</h5>
                    <div class="table-responsive">
                        <table class="table table-bordered text-center mt-1">
                            ...
                            $class = new Database;
                            $select_all = $class->select_all_data_mahasiswa();
                            ...
                            <tr class="mt-3">
                                ...
                                <td scope="col"><a class="btn btn-warning text-white btn-sm"
                                        href="form_update_mahasiswa.php?username=<?php echo $data['username'] ?>"><i
                                            class="bi bi-pen"></i></a>
                                    <a class="btn btn-danger btn-sm"
                                        href="proses_delete_mahasiswa.php?username=<?php echo $data['username'] ?>"
                    ...
                    <a class="btn btn-primary btn-sm mt-4" href="form_add_mahasiswa.php">Add <i
