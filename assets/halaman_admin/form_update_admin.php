        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active"
                    href="settings.php"><i class="bi bi-gear-fill"></i>
                    Setting</a>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        $class = new Database;
                        $select = $class->view_data_admin();
                        $data = mysqli_fetch_array($select);
                        ?>
                        <form method="post" action="proses_update_admin.php"
                            ...
                            <div class="mb-4 mt-4">
                                <label for="exampleInputPassword1" class="form-label">Username <i
                                        class="bi bi-person-circle"></i></label>
                                <input value="<?php echo $data['username'] ?>" name="username" type="text"
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a class="btn btn-primary btn-sm mb-3" href="settings.php"><i
