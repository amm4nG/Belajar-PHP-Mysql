        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active"
                    href="data_mahasiswa.php"><i class="bi bi-person-workspace"></i>
                    Mahasiswa</a>
                ...
                <div class="text-center">
                    <a class=list-group-item list-group-item-action list-group-item-light p-3"
                        href="assets/form_login/form_login_mahasiswa.php"
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        <form action="proses_add_mahasiswa.php" method="post"
                            class="form-control border border-primary mt-4 p-4">
                            <h5 class="text-center mb-4">Create Account <i class="bi bi-box-arrow-in-right"></i></h5>
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                <button name="add" type="submit" class="btn btn-success btn-sm mt-4 mb-1 center">C r e a
                                    t e <i class="bi bi-person-plus-fill"></i></button>
                                <a class="btn btn-primary btn-sm mb-3" href="data_mahasiswa.php"><i
